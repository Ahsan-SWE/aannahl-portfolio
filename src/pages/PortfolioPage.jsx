...
const ProjectDetails = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: "CakePHP",
      link: "#",
      description: "Custom platform developed using CakePHP to streamline operational workflows and enhance user engagement for Boosters of America. It includes secure data handling and interactive features.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/Boa1.jpg",
    ...
    },
    {
      ...
      tech: "CakePHP",
      link: "#",
      description: "Poundwishes is a dedicated platform connecting animal lovers with rescue shelters. Developed using CakePHP to provide a robust donation and adoption management system.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/PW1.jpg",
    ...
    },
    {
      ...
      tech: "Wordpress",
      link: "#",
      description: "A modern, highly optimized WordPress website designed for local business outreach. Focused on high conversion rates and seamless mobile responsiveness.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/PM1.jpg",
    ...
    },
    {
      ...
      tech: "Wordpress",
      link: "#",
      description: "An innovative digital portal built on WordPress, featuring custom plugins and dynamic content structures to enhance user retention.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/IZI1.jpg",
    ...
    },
    {
      ...
      tech: "CakePHP2",
      link: "#",
      description: "A comprehensive dashboard for managing large-scale HCM content. Features include real-time analytics, user access controls, and detailed reporting modules.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/HCD1.jpg",
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200",
    ...
    },
    {
      ...
      tech: "Laravel",
      link: "#",
      description: "Advanced analytics integration built with Laravel. This dashboard seamlessly connects with Piwik (Matomo) for precise data tracking and visualization.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/HPW1.jpg",
        "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200",
    ...
    },
    {
      ...
      tech: "PHP",
      link: "#",
      description: "A specialized PHP-based scheduling system. Allows businesses to seamlessly manage bookings, appointments, and customer calendars.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/BA1.jpg",
        "https://images.unsplash.com/photo-1506784951206-056bd5c59f0f?q=80&w=1200",
    ...
    },
    {
      ...
      tech: "Wordpress, jQuery, PHP",
      link: "#",
      description: "A feature-rich platform to help users quote and book moving services online effortlessly. Integrates interactive jQuery elements and a robust PHP backend.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/MR1.jpg",
    ...
    },
    {
      ...
      tech: "Wordpress, jQuery, PHP",
      link: "#",
      description: "A visually appealing and conversion-optimized website for Gentle Moving company. Enables quick estimates and seamless customer support integration.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/GM1.jpg",
        "https://images.unsplash.com/photo-1586528116311-ad8dd3c8317d?q=80&w=1200",
        "https://images.unsplash.com/photo-1555529733-0e670560f8e1?q=80&w=1200"
      ]
    },
    {
      id: 13,
      ...
      tech: "Laravel",
      link: "#",
      description: "A secure and highly scalable human capital management dashboard built with Laravel. Streamlines HR operations and internal company communications.",
      images: [
        "https://aan-nahl.com/wp-content/uploads/2018/03/HCM01-1.jpg",
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200",
        "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1200"
      ]
    }
  ...
  // Logic to find exact project. If not found, fallback to the first one safely.
  ...
  // Auto Reset Image & Scroll to Top on new Project Load
  useEffect(() => {
    setCurrentImg(0);
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24 font-sans selection:bg-[#f97316] selection:text-white">
      ...
      <div className="max-w-[75rem] mx-auto px-6 relative mb-16">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUp} className="max-w-4xl mx-auto">
          ...
          <div className="relative aspect-[16/10] bg-gray-100 border border-gray-200 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)]">
